...
log_special_matrix = numpy.log(t_special)
	...
	if i == n:       
		for k in range(m): # state at i
			for j in range(m): # state at i - 1
				...
				t = log_special_matrix[j, k] # transition log probability
